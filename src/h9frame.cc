...
const char* H9frame::type_to_string(H9frame::Type type) {
    switch (type) {
        ...
        case Type::NODE_SPECIFIC_BULK0: return "NODE_SPECIFIC_BULK0";
        case Type::NODE_SPECIFIC_BULK1: return "NODE_SPECIFIC_BULK1";
        case Type::NODE_SPECIFIC_BULK2: return "NODE_SPECIFIC_BULK2";
        case Type::NODE_SPECIFIC_BULK3: return "NODE_SPECIFIC_BULK3";
        case Type::NODE_SPECIFIC_BULK4: return "NODE_SPECIFIC_BULK4";
        case Type::NODE_SPECIFIC_BULK5: return "NODE_SPECIFIC_BULK5";
        case Type::NODE_SPECIFIC_BULK6: return "NODE_SPECIFIC_BULK6";
        case Type::NODE_SPECIFIC_BULK7: return "NODE_SPECIFIC_BULK7";
    }
    return nullptr;
}
